...
import getLatestAddedTvSeries from '@salesforce/apex/TVSerieController.getLatestAddedTvSeries';
import { NavigationMixin } from 'lightning/navigation';

export default class LatestTVSeries extends NavigationMixin(LightningElement) {
    tvSeries = [];

    connectedCallback() { //runs on TvSeries initialization
        getLatestAddedTvSeries({maxLatestAdded: 8})
        .then(data => {
